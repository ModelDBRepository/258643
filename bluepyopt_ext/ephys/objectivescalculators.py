...
class ObjectivesCalculator(object):
    ...
    def calculate_all_feature_values(self, responses):
        """Calculate the feature value for every objective"""
        
        return {objective.name: objective.calculate_feature_values(responses)
            for objective in self.objectives}
